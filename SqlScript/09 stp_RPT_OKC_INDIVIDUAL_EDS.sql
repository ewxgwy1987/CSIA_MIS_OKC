...
BEGIN
	...
	UPDATE	#INDIV_EDS_STATUS
	SET		JAMS =	dbo.RPT_GET_FAULT_DURATION(@DTFROM,@DTTO,@EDS_SUBSYSTEM,@PRE_XM_LOCATION,'AA_BJAM')
				  + dbo.RPT_GET_FAULT_DURATION(@DTFROM,@DTTO,@EDS_SUBSYSTEM,@EDS_LOCATION,'AA_BJAM')
				  + dbo.RPT_GET_FAULT_DURATION(@DTFROM,@DTTO,@EDS_SUBSYSTEM,@POST_XM_LOCATION,'AA_BJAM')
