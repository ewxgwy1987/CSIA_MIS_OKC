...
ALTER PROCEDURE dbo.stp_RPT_OKC_TRACKINGSTAT
		@DTFrom [datetime],
		@DTTo [datetime],
...
BEGIN
	...
	(
		...
		FROM MDS_BAG_COUNT MBC, MDS_BAG_COUNTERS MBCR, SUBSYSTEM_COUNT SC WITH(NOLOCK)
		WHERE MBC.COUNTER_ID=MBCR.COUNTER_ID
			AND MBCR.LOCATION=SC.DETECT_LOCATION AND MBCR.SUBSYSTEM=SC.SUBSYSTEM
