...
CREATE PROCEDURE dbo.stp_RPT_OKC_PermanentFlight
		@DTFrom DATETIME,
		@DTTo DATETIME,
...
BEGIN
	...
	WHERE	TFPA.STO BETWEEN @STO_FROM AND @STO_TO
		AND TFPA.AIRLINE IN (SELECT * FROM DBO.RPT_GETPARAMETERS(@AIRLINES))
