...
BEGIN
	...
	SELECT P1500.LOCATION,P1500.BIT_STATION,P1500.ETD_STATION,P1500.LICENSE_PLATE,P1500.BAG_STATUS
	...
	SELECT	CBRA_LOC.SUBSYSTEM AS CBRA_ID, 
			'BIT '+ P1500.ETD_STATION + CASE CBRA_LOC.SUBSYSTEM WHEN 'AL1' THEN 'A' ELSE '' END AS INSPECTION_TABLE_ID,
