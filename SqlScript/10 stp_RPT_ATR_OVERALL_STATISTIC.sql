...
BEGIN
	...
	SELECT	ISC.TIME_STAMP, ISC.GID,ISC.LICENSE_PLATE1,ISC.LICENSE_PLATE2,ISC.STATUS_TYPE, LOC.LOCATION AS ATRUNIT, 0 AS LATE_MARK 
	INTO	#ATR_ISC_TEMP
	...
	SELECT	MAX(TIME_STAMP) AS TIME_STAMP,GID,LICENSE_PLATE1,LICENSE_PLATE2,STATUS_TYPE, ATRUNIT, LATE_MARK
	INTO	#ATR_ATRDETAIL_TEMP
	FROM	#ATR_ISC_TEMP
	GROUP BY GID,LICENSE_PLATE1,LICENSE_PLATE2,STATUS_TYPE, ATRUNIT, LATE_MARK
